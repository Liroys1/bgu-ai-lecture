  ...
  return `
    ...
    <div class="frame schreiber-slide">
      ...
      <div class="grid anim-fade" style="animation-delay:0.3s">
        ...
        <div class="video-embed-wrapper" id="schreiber-vid-wrap">
          <div class="video-thumb-link" onclick="
            var w=document.getElementById('schreiber-vid-wrap');
            w.innerHTML='<iframe class=\\'schreiber-iframe\\' src=\\'https://www.youtube.com/embed/5gqtckj0Ohc?autoplay=1&rel=0\\' frameborder=\\'0\\' allow=\\'autoplay; encrypted-media; fullscreen\\' allowfullscreen></iframe>';
          ">
