...
import { v2s06, v2s09 } from '../slides-v2/s03-eras';
import { v2s11, v2s12, v2s13 } from '../slides-v2/s04-stats';
import { v2s14, v2s15, v2s16, v2s17, v2s18 } from '../slides-v2/s05-voices';
import { v2s21 } from '../slides-v2/s07-role';
import { v2s32, v2s33, v2s34, v2s35, v2s36 } from '../slides-v2/s10-additions';

import { v6s02 } from './s01-intro';
import { v6s03, v6s04 } from './s02-story';
import { v6s29, v6s05, v6s05b } from './s03-why';
...
export const SLIDES_V6 = [
  ...
  v2s32,          // 18 63%
  v2s33,          // 19 +25%
  v2s14,          // 20 ACT II chapter
  v2s15,          // 21 3 VOICES
  v2s16,          // 22 ALTMAN
  v2s17,          // 23 MATIAS
  v2s18,          // 24 HASSABIS
  v2s34,          // 25 JOBS JUNIOR
  v2s35,          // 26 JOBS SENIOR
  v6s_local,      // 27 CLOSE TO HOME — Daniel + Calcalist merged
  v2s21,          // 28 ACT III chapter
